...
public class LevelThree implements Screen {
    ...
    public void show() {
        ...
        //setup spawner
        spawner = new Spawner(4,matrix,camera);
    ...
    public void render(float delta) {
        ...
        switch (gameState) {
            ...
            case CHECK:
                ...
                score = points;
                if(score > ScoreManager.getScore(ScoreManager.LEVEL_3)){
                    ScoreManager.setScore(ScoreManager.LEVEL_3,score);
