...
/**
 * Class to display level 4 of the game.
 */
public class LevelFour implements Screen {
    ...
    public void show() {
        ...
        //setup spawner
        spawner = new Spawner(5,matrix,camera);
    ...
    public void render(float delta) {
        ...
        switch (gameState) {
            ...
            case CHECK:
                ...
                score = points;
                if(score > ScoreManager.getScore(ScoreManager.LEVEL_4)){
                    ScoreManager.setScore(ScoreManager.LEVEL_4,score);
