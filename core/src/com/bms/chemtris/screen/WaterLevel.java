...
/**
 * Class to control water level.
 */
public class WaterLevel implements Screen {
    //game state members
    ...
    public void show() {
        ...
        //make stages
        stage = new Stage();
        particler = new ParticleRender(ParticleRender.blue,stage);
        ...
        ry = ButtonLoader.ry();
        rz = ButtonLoader.rz();
        tutorialImage = new Image(TextureLoader.getWat());
    ...
    public void render(float delta) {
        ...
        switch (gameState) {
            ...
            case CHECK:
                ...
                score = points;
                if(score > ScoreManager.getScore(ScoreManager.H2O)){
                    ScoreManager.setScore(ScoreManager.H2O,score);
