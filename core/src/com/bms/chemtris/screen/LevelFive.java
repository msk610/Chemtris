...
/**
 * Screen that displays level 5 of the game.
 */
    ...
    public void render(float delta) {
        ...
        switch (gameState) {
            ...
            case CHECK:
                ...
                score = points;
                if(score > ScoreManager.getScore(ScoreManager.LEVEL_5)){
                    ScoreManager.setScore(ScoreManager.LEVEL_5,score);
