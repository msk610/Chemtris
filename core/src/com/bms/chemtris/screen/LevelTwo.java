...
/**
 * Screen that displays level 2 of the game.
 */
public class LevelTwo implements Screen {
    ...
    public void show() {
        ...
        //setup spawner
        spawner = new Spawner(3,matrix,camera);
    ...
    public void render(float delta) {
        ...
        switch (gameState) {
            ...
            case CHECK:
                ...
                score = points;
                if(score > ScoreManager.getScore(ScoreManager.LEVEL_2)){
                    ScoreManager.setScore(ScoreManager.LEVEL_2,score);
